...
import com.nordicloop.toothpickworkshop.binding.InjectedFullNameProvider;
...
public class Advanced4Activity extends AppCompatActivity {
  @Inject
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    scope.installModules(new Module() {{
      ...
      bind(FullName.class).toProvider(InjectedFullNameProvider.class);
    }});
